...
Future<String> _generateText(String promptPlantName) async {
  ...
  // String prompt = 'tuliskan dengan format nama : lidah mertua, genus: , family: , order: , class: , phylum: , perawatan: (maks 4) [ { jenis_perawatan : sinar matahari nilai : (isi banyak, secukupnya, atau rendah) (sebagai indikator cahaya yang diperlukan) icon:Icons.sunny deskripsi: ... }, { jenis_perawatan : air nilai : (beri nilai integer maks 7 yang menandakan 7hari) (sebagai indikator berapa hari sekali penyiraman yang diperlukan) icon: Icons.water_drop deskripsi: ... }, { jenis_perawatan : pemupukan nilai : (perlu, tidak perlu) (sebagai indikator apakah perlu pemupukan atau tidak) icon: Icons.health_and_safety deskripsi: ... }, { jenis_perawatan : pemangkasan nilai : (perlu, tidak perlu) (sebagai indikator apakah perlu pemangkasan atau tidak) icon: Icons.cut deskripsi: ... }, ]  berbentuk json, disclaimer hanya berikan format json saja';
