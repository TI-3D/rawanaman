...
Future<String> _generateText(String promptPlantName) async {
  ...
  String prompt =
      'tuliskan dalam bahasa inggris dengan format nama : $promptPlantName, deskripsi: (singkat), genus: , family: , order: , class: , phylum: , nama_latin: , perawatan: (maks 4) [ { jenis_perawatan : Sunlight nilai : (isi banyak, secukupnya, atau rendah) (sebagai indikator cahaya yang diperlukan) icon:Icons.sunny deskripsi: ... }, { jenis_perawatan : Watering nilai : (beri nilai integer maks 7 yang menandakan 7hari) (sebagai indikator berapa hari sekali penyiraman yang diperlukan) icon: Icons.water_drop deskripsi: ... }, { jenis_perawatan : Fertilization nilai : (perlu, tidak perlu) (sebagai indikator apakah perlu pemupukan atau tidak) icon: Icons.health_and_safety deskripsi: ... }, { jenis_perawatan : Trimming nilai : (perlu, tidak perlu) (sebagai indikator apakah perlu pemangkasan atau tidak) icon: Icons.c/ut deskripsi: ... }, {penyakit_umum: (maks 4)[nama_penyakit: , ciri_penyakit:  ]} ]  berbentuk json, disclaimer hanya berikan format json saja';
